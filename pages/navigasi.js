...
export default function Navigasi() {
    ...
    return (
        ...
        <div>
            <nav className="w-full bg-white shadow" style={{ position: "fixed", zIndex: "1" }}>
                    ...
                    >
                        ...
                        <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                            <li className="text-pink-500 ">
                                <Link href="javascript:void(0)"><a className='text-pink-500 hover:text-white hover:bg-pink-500 pt-5 pb-5 px-5 text-lg'>Home</a></Link>
                            </li>
                            <li className="text-pink-500 ">
                                <Link href="javascript:void(0)"><a className='text-pink-500 hover:text-white hover:bg-pink-500 pt-5 pb-5 px-5 text-lg'>Product</a></Link>
                            </li>
                            <li className="text-pink-500 ">
                                <Link href="javascript:void(0)"><a className='text-pink-500 hover:text-white hover:bg-pink-500 pt-5 pb-5 px-5 text-lg'>Transaksi</a></Link>
                            </li>
                        </ul>
